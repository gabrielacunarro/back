class EventManager {
    ...
    constructor(data) {
        ...
        this.capacity = data.capacity || 50 // esto se puede obviar, podemos hacerlo directamente con el create.
...
const events = new EventManager({ name: "harry potter 1", place: "cinemark" });
events.create({
    name: "harry potter 2",
    place: "village"
})
...
events.soldTicket(15,4)
events.soldTicket(4,3)
console.log(events.read());
